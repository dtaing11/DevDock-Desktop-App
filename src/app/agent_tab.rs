...
fn task_panel(app: &mut App, ui: &mut egui::Ui) {
    ...
    ui.horizontal(|ui| {
        ...
        if busy {
            ...
            if ui
                .add_enabled(ready, egui::Button::new("Run in a worktree").fill(theme::green()))
                .on_hover_text(
            ...
            .add_enabled(ready, egui::Button::new("Run").fill(theme::green()))
        ...
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    if ui.add_enabled(ready, egui::Button::new("Answer").fill(theme::green())).clicked() {
                        answer = true;
                    }
        ...
        if live {
            ...
            if ui
                .add_enabled(
                    ...
                    egui::Button::new("Keep everything").fill(theme::green()),
                )
            ...
            .add_enabled(
                pending > 0,
                egui::Button::new(format!("Apply {pending} selected")).fill(theme::green()),
            )
