...
fn pull_requests(app: &mut App, ctx: &egui::Context, open: &mut bool) {
    modal(ctx, "Pull requests", open, |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add_enabled(create_enabled, egui::Button::new("Create PR").fill(theme::green()))
                .clicked()
            {
    ...
    modal(ctx, "Resolve conflicts", open, |ui| {
        ...
        if let Some(i) = app.conflicts.selected {
            ...
            if proposal_here {
                ...
                ui.horizontal(|ui| {
                    if ui
                        .add(egui::Button::new("Accept AI merge").fill(theme::green()))
                        .on_hover_text(
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add_enabled(
                    ...
                    egui::Button::new("Finish (continue merge/rebase)").fill(theme::green()),
                )
                .clicked()
            {
...
fn ci_config_review(app: &mut App, ctx: &egui::Context, open: &mut bool) {
    modal(ctx, "Review AI-generated CI config", open, |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add_enabled(parsed.is_ok(), egui::Button::new(save_label).fill(theme::green()))
                .clicked()
            {
...
fn agent_panel(app: &mut App, ui: &mut egui::Ui) {
    ui.horizontal(|ui| {
        ...
        if busy {
            ...
            .add_enabled(
                enabled,
                egui::Button::new("Resolve all with AI").fill(theme::green()),
            )
            .on_hover_text(
...
fn rename_dialog(app: &mut App, ctx: &egui::Context, open: &mut bool) {
    ...
    modal(ctx, "Rename symbol", open, |ui| {
        ...
        ui.horizontal(|ui| {
            let clicked = ui
                .add_enabled(valid, egui::Button::new("Rename").fill(theme::green()))
...
fn add_remote(app: &mut App, ctx: &egui::Context, open: &mut bool) {
    modal(ctx, "Publish: add a remote", open, |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add_enabled(can_add, egui::Button::new("Add remote and publish").fill(theme::green()))
                .clicked()
            {
